...
class LioSensitiveLifecycleInventory {
  ...
  static const canonicalOwners = {
    ...
    LioSensitiveDataDomain.healthObservation: 'HealthRepository / Data layer',
  ...
  List<LioSensitiveLifecycleRecord> get productionEntries => const [
        ...
        LioSensitiveLifecycleRecord(
          ...
          callerSurface: 'Application',
          operation: 'READ_HEALTH / WRITE / UPDATE / ARCHIVE',
          dataDomain: LioSensitiveDataDomain.healthObservation,
          classification: LioLifecycleOpKind.readHealth,
          risk: 'medium',
          canonicalOwner: 'HealthRepository / Data layer',
          passesLioEntry: true,
          hasRealExecution: true,
          notes:
              'Entry → Application → Repository. LIO authorize-only. '
              'ARCHIVE soft status ≠ DELETE PHR.',
        ),
        LioSensitiveLifecycleRecord(
          path: 'lib/core/health_data/health_repository.dart',
          classOrFunction: 'HealthDataRepository',
          ...
          passesLioEntry: true,
          hasRealExecution: true,
          notes: 'UI/Agent/LIO must not call repository directly',
        ),
        LioSensitiveLifecycleRecord(
